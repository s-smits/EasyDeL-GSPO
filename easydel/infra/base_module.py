...
class EasyDeLBaseModule(nn.Module, BaseModuleProtocol, EasyBridgeMixin, EasyGenerationMixin):
    ...
    def to_state(
        ...
        # Ensure input shardings are concrete NamedShardings (not bare PartitionSpecs)
        gstatesh = jax.tree_util.tree_map(_to_namedsharding, gstatesh)
        gothersh = jax.tree_util.tree_map(_to_namedsharding, gothersh)
